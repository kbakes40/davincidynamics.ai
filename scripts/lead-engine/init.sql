-- Lead Engine schema (MySQL). Matches `drizzle/leadEngineSchema.ts`.
...
CREATE TABLE IF NOT EXISTS `lead_engine_leads` (
  ...
  `outreach_status` enum(
    'new','researched','drafted','ready_to_send','sent','replied','interested','not_interested','follow_up_needed'
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_norm_phone` ON `lead_engine_leads` (`normalized_phone`);
CREATE INDEX IF NOT EXISTS `idx_lead_engine_norm_site` ON `lead_engine_leads` (`normalized_website`);
CREATE INDEX IF NOT EXISTS `idx_lead_engine_norm_name` ON `lead_engine_leads` (`normalized_business_name`);
CREATE INDEX IF NOT EXISTS `idx_lead_engine_pipeline` ON `lead_engine_leads` (`pipeline_stage`);
CREATE INDEX IF NOT EXISTS `idx_lead_engine_score` ON `lead_engine_leads` (`score`);
CREATE INDEX IF NOT EXISTS `idx_lead_engine_source_record_id` ON `lead_engine_leads` (`source_record_id`);
CREATE INDEX IF NOT EXISTS `idx_lead_engine_priority` ON `lead_engine_leads` (`priority`);
CREATE INDEX IF NOT EXISTS `idx_lead_engine_source` ON `lead_engine_leads` (`source`);

CREATE TABLE IF NOT EXISTS `lead_engine_contact_points` (
  `id` varchar(32) NOT NULL,
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_cp_lead` ON `lead_engine_contact_points` (`lead_id`);

CREATE TABLE IF NOT EXISTS `lead_engine_addresses` (
  `id` varchar(32) NOT NULL,
  `lead_id` varchar(32) NOT NULL,
  `address_1` text,
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_addr_lead` ON `lead_engine_addresses` (`lead_id`);
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_src_lead` ON `lead_engine_sources` (`lead_id`);
CREATE INDEX IF NOT EXISTS `idx_lead_engine_src_batch` ON `lead_engine_sources` (`import_batch_id`);

CREATE TABLE IF NOT EXISTS `lead_engine_enrichment` (
  `id` varchar(32) NOT NULL,
  `lead_id` varchar(32) NOT NULL,
  `website_status` varchar(32) NOT NULL DEFAULT 'unknown',
  `google_business_profile` varchar(1024) NULL,
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_enrichment_status` ON `lead_engine_enrichment` (`website_status`);

CREATE TABLE IF NOT EXISTS `lead_engine_scoring_events` (
  `id` varchar(32) NOT NULL,
  `lead_id` varchar(32) NOT NULL,
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_score_lead` ON `lead_engine_scoring_events` (`lead_id`);

CREATE TABLE IF NOT EXISTS `lead_engine_outreach_events` (
  `id` varchar(32) NOT NULL,
  `lead_id` varchar(32) NOT NULL,
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_outreach_lead` ON `lead_engine_outreach_events` (`lead_id`);

CREATE TABLE IF NOT EXISTS `lead_engine_import_batches` (
  `id` varchar(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `lead_engine_agent_queues` (
  `id` varchar(32) NOT NULL,
  `lead_id` varchar(32) NOT NULL,
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_aq_lead` ON `lead_engine_agent_queues` (`lead_id`);

CREATE TABLE IF NOT EXISTS `lead_engine_pipeline_events` (
  `id` varchar(32) NOT NULL,
  `lead_id` varchar(32) NOT NULL,
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_pe_lead` ON `lead_engine_pipeline_events` (`lead_id`);

CREATE TABLE IF NOT EXISTS `lead_engine_activity_log` (
  `id` varchar(32) NOT NULL,
  `lead_id` varchar(32) NOT NULL,
...
CREATE INDEX IF NOT EXISTS `idx_lead_engine_act_lead` ON `lead_engine_activity_log` (`lead_id`);
