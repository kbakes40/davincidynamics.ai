...
export function mapJoinToLead(j: LeadJoinData): Lead {
  ...
  return {
    ...
    instagram: j.instagram,
    linkedin: j.linkedin,
    verificationStatus: j.lead.verificationStatus as Lead["verificationStatus"],
    leadScore: j.lead.score,
    pipelineStage: j.lead.pipelineStage as Lead["pipelineStage"],
    source: j.lead.source,
    sourceJobId: j.lead.sourceJobId,
    priority: j.lead.priority as Lead["priority"],
    status: j.lead.outreachStatus as Lead["status"],
    websiteStatus,
