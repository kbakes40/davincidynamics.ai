...
const SITE_TITLE = "Own Your Ecommerce Stack";
const SITE_DESCRIPTION =
  "Stop renting your business from platforms. DaVinci Dynamics builds custom ecommerce systems designed for control, conversion, and margin.";
