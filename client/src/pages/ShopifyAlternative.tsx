...
const PAGE_TITLE = "Stop Paying Platform Fees";
const PAGE_DESCRIPTION =
  "We help brands move beyond Shopify platform costs with custom ecommerce systems built for ownership, automation, and profit.";
