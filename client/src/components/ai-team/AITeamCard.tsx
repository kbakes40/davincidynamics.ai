  ...
  return (
    <article
      ...
      className={cn(
        ...
        highlight === "primary" &&
          "border-[rgba(var(--va),0.62)] shadow-[0_0_0_1px_rgba(var(--va),0.35),0_28px_90px_rgba(0,0,0,0.58),0_0_76px_-10px_rgba(var(--va),0.42),inset_0_1px_0_rgba(255,255,255,0.08)]",
        highlight === "secondary" &&
    ...
    >
      <div
        ...
        className="relative z-10 flex min-h-0 flex-1 cursor-pointer flex-col gap-4 p-6 outline-none focus-visible:ring-2 focus-visible:ring-[rgba(var(--va),0.45)] pointer-events-auto"
